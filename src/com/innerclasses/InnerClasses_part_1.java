...
class Unviersity{
	...
	public static void main(String arg[]) {
		System.out.println("university main method");
	}
}
public class InnerClasses_part_1 {
	...
	public static void main(String[] args) {
		System.out.println("InnerClasses_part_1 main method");
		 ...
		 * but bcz of power full features and benifits of inner classes , slowly prog. 
		 ...
		 OBJECT ewe defined department class inside university
		 ...
		 if we are declear any named class, directly inside a class without a ststic modifier
		  ...
		  jar file = conatins a group of dot classf files
